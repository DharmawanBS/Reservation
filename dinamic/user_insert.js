        ...
        rows => {
            if (rows != null) {
                ...
                if (view_user === null) {
                    ...
                    view_user.forEach(function (item) {
                        ...
                        if (view_user_view === null) {
                            ...
                            if (arr_column.includes(view_user_column)) {
                                ...
                                if (str_column === "") str_column = "'" + view_user_column + "'";
                                else str_column = str_column + ",'" + view_user_column + "'";
                                arr_column.push(view_user_column);
                                obj_column.push([
                                    view_user_view,
                                    view_user_column,
                    ...
                    let query = "select count(*) as count from view_user where view_user_column in (" + str_column + ")";
